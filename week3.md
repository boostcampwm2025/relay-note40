...
#### K021 - 3번 퀘스트:  기분 따라 선곡해주는 AI 라디오

학습과 구현을 정신없이 하다보면 잠깐 쉬어가는 시간이 필요하더라구요. 그럴 때 기분 전환을 위해서 가장 먼저 하는 것이 기분 좋아지기 위한 "노래"를 선택하는 것이어서, 그걸 AI에게 지금 기분을 설명하고 추천을 받으면 매번 듣던 노래가 아니라 새로운 노래인데 제 취향인 노래를 발견할 수 있지 않을까 싶어서 선택했습니다.

#### J096 - 나만의 맞춤 회복템 찾기

ai한테 지친 몸을 회복시켜줄 수 있는 아이템을 추천받고 정말 괜찮은 물건이 있으면 사서 실제로 도움을 받을 수 있어서 선택했습니다. 또 재밌는 물건을 추천해주면 슬랙으로 공유도 해볼 수 있어 재미있을 것 같아요.

#### J008 - 성취감 사냥 퀘스트

과제에만 집중하다보면 구현하지 못한 부분에 대해 늘 아쉬움이 남는데, 소소한 퀘스트를 달성하면서 리프레시도 하고 성취감도 느끼고 싶어 선택했습니다. 예시로 나온 퀘스트들이 재밌어 보였어요 😆

#### J288 - 기분 따라 선곡해주는 AI 라디오

챌린지 과제에 빠져 살다보니 좋은 노래를 찾아 들었던 기억도 너무 오래 된 것 같다. 이 퀘스트를 통해 내 기분에 맞는 좋은 노래를 추천 받아 하루를 기분좋게 시작하고 싶어 선택하였다.
