...
AI가 그날 감정에 맞는 미션을 제안해줘서 매일 하루를 소소하게 웃으면서 시작할 수 있었고, 덕분에 감정을 가볍게 넘기지 않고 재미있게 마주하는 방법을 알게 됐습니다.
...
2. 나만의 GPT 구성에 **이름, 설명, 지침, 대화 스타터**를 다음과 같이 작성후 생성합니다.
- **`이름`**: 자존감 지키미
...
- **AI 역할** ⇒ 단순히 프롬프트를 통해 AI가 사용자에게 위로를 할 수 있도록 만들었습니다.
- 한번 프롬프트를 작성하면 간편히 힘들때마다 돌릴 수 있어서 간편했습니다.
- AI가 주는 위로의 말이 생각보다 많은 힘이 되어서 놀라면서 자부심도 얻게 되었습니다.
...
![](https://i.imgur.com/we7FbLN.png)

4. 미션 수행 결과

당장 눈을 감고 침대로 가기 (미션완료 🫠 )

**느낀점**   
퀘스트가 학습과 성장에 직접적인 도움이 되지는 않았지만 미션을 진한하는 도중에 기분전환에 도움이 되었습니다. ai에게 간단한 미션을 받아 수행하는 퀘스트였는데 ai가 내주는 미션이 너무 간단해서 난이도는 매우쉬움이였습니다. ai를 사용할 때 보통 모르는 것을 물어보는 식의 학습용으로 사용했었는데 ‘이런식으로도 사용할 수 있구나’ 를 느낄수 있었습니다.
...
### 경험하는 과정을 통해 느낀 점과 배운 점

이번 퀘스트로 AI의 잠재력과 명확한 한계를 동시에 느꼈습니다. 간단한 프롬프트로 개인화된 음악 추천 기능이 가능하다는 잠재력을 보았지만, '10점 만점에 10점 ㅠㅠ' 같은 복합적인 감정이 섞인 표현은 AI가 해석하지 못하는 한계를 확인했습니다. 아직 LLM 보다는 인간이 나은거 같네요 ㅎㅎ